...
- [`protocol-project-content`](../../engine-rs/crates/protocol/protocol-project-content/Cargo.toml) — active
...
- [`svc-environment-authoring`](../../engine-rs/crates/services/svc-environment-authoring/Cargo.toml) — active
...
- [`svc-project-content`](../../engine-rs/crates/services/svc-project-content/Cargo.toml) — active
...
- [`@asha/contracts`](../../ts/packages/contracts/package.json) — public; roles: asha-testing, asha-demo, asha-studio, downstream-authoring, downstream-visual-authoring
...
- [`@asha/game-workspace`](../../ts/packages/game-workspace/package.json) — unstable; roles: asha-testing, asha-demo, asha-studio, downstream-authoring, downstream-visual-authoring
...
- [`@asha/renderer-host`](../../ts/packages/renderer-host/package.json) — unstable; roles: asha-demo, asha-studio, downstream-visual-authoring
- [`@asha/renderer-three`](../../ts/packages/renderer-three/package.json) — unstable; roles: asha-testing
- [`@asha/runtime-bridge`](../../ts/packages/runtime-bridge/package.json) — public; roles: asha-testing, asha-demo, asha-studio, downstream-authoring, downstream-visual-authoring
- [`@asha/runtime-session`](../../ts/packages/runtime-session/package.json) — unstable; roles: asha-testing, asha-demo, asha-studio, downstream-authoring, downstream-visual-authoring
...
- `admit_runtime_project_source_batch` — stable; output `protocol_project_bundle::ProjectSourceBatchValidationReceipt`
...
- `apply_procedural_environment` — stable; output `protocol_project_content::ProceduralEnvironmentApplyResult`
- `apply_project_content_authoring` — stable; output `protocol_project_content::ProjectContentAuthoringResult`
...
- `begin_runtime_project_source_resources` — stable; output `protocol_project_bundle::ProjectResourceTransactionReceipt`
- `close_runtime_project` — stable; output `protocol_project_bundle::RuntimeProjectCloseReceipt`
- `close_workspace_authoring` — stable; output `protocol_project_bundle::WorkspaceAuthoringCloseReceipt`
...
- `confirm_project_write` — stable; output `protocol_project_bundle::ProjectWriteConfirmReceipt`
- `confirm_workspace_authoring_stored` — stable; output `protocol_project_bundle::WorkspaceAuthoringStoredConfirmationReceipt`
- `create_camera` — stable; output `protocol_view::CameraSnapshot`
- `decode_project_content` — stable; output `protocol_project_content::ProjectContentCodecResult`
- `decode_scene_document` — stable; output `protocol_scene::SceneDocumentCodecResult`
- `encode_project_content` — stable; output `protocol_project_content::ProjectContentCodecResult`
...
- `load_runtime_project` — stable; output `protocol_project_bundle::RuntimeProjectLoadReceipt`
...
- `open_workspace_authoring` — stable; output `protocol_project_bundle::WorkspaceAuthoringStateSummary`
...
- `prepare_project_write` — stable; output `protocol_project_bundle::ProjectWritePrepareReceipt`
- `preview_procedural_environment` — stable; output `protocol_project_content::ProceduralEnvironmentPreviewResult`
...
- `read_active_runtime_project_content` — stable; output `protocol_project_content::ActiveRuntimeProjectContentReadout`
...
- `stage_runtime_project_source_resource` — stable; output `protocol_project_bundle::StagedProjectResourceRef`
...
Committed path classes: 764 source; 27 generated source; 543 other; 0 build/cache/output.
...
| `core-assets` (rust-foundation) | actual: none<br>allowed: none | 19/0 | none | `asset-import`, `core-catalog`, `core-entity`, `core-scene`, `protocol-assets`, `render-audio`, `render-billboard`, `render-bridge`, `render-particle`, `rule-project-bundle`, `runtime-bridge-api`, `scene-diagnostics`, `svc-entity-authoring`, `svc-environment-authoring`, `svc-policy-view`, `svc-project-content`, `svc-serialization`, `svc-voxel-annotation`, `svc-voxel-asset` |
| `core-catalog` (rust-state) | actual: `core-assets`, `core-voxel`<br>allowed: `core-assets`, `core-voxel` | 8/2 | none | `asset-import`, `render-audio`, `render-billboard`, `render-bridge`, `render-particle`, `runtime-bridge-api`, `scene-diagnostics`, `svc-project-content` |
...
| `core-ids` (rust-foundation) | actual: none<br>allowed: none | 52/0 | none | `asset-import`, `core-commands`, `core-entity`, `core-events`, `core-game-rules`, `core-scene`, `core-snapshot`, `core-state`, `game-rule-extension`, `gameplay-module-sdk`, `gameplay-runtime-host`, `native-bridge`, `protocol-assets`, `protocol-codegen`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-game-rules`, `protocol-ids`, `protocol-policy-view`, `protocol-presentation`, `protocol-project-bundle`, `protocol-project-content`, `protocol-render`, `protocol-replay`, `protocol-scene`, `protocol-script`, `render-animation`, `render-bridge`, `render-debug`, `rule-animation-controller`, `rule-game-modifier`, `rule-gameplay-fabric`, `rule-lifecycle`, `rule-process`, `rule-project-bundle`, `rule-relationship`, `rule-state-machine`, `rule-trigger-volume`, `runtime-bridge-api`, `scene-diagnostics`, `sim-applier`, `sim-kernel`, `sim-replay`, `sim-runner`, `sim-validator`, `svc-combat`, `svc-entity-authoring`, `svc-environment-authoring`, `svc-game-rules`, `svc-policy-view`, `svc-project-content`, `svc-serialization` |
| `core-math` (rust-foundation) | actual: none<br>allowed: none | 16/0 | none | `core-entity`, `core-scene`, `gameplay-runtime-host`, `native-bridge`, `render-bridge`, `rule-gameplay-fabric`, `rule-project-bundle`, `rule-trigger-volume`, `rule-voxel-edit`, `runtime-bridge-api`, `scene-diagnostics`, `svc-entity-authoring`, `svc-environment-authoring`, `svc-pathfinding`, `svc-physics`, `svc-policy-view` |
| `core-scene` (rust-state) | actual: `core-assets`, `core-entity`, `core-error`, `core-ids`, `core-math`<br>allowed: `core-assets`, `core-entity`, `core-error`, `core-ids`, `core-math` | 9/5 | none | `gameplay-runtime-host`, `render-bridge`, `rule-project-bundle`, `rule-voxel-edit`, `runtime-bridge-api`, `scene-diagnostics`, `svc-environment-authoring`, `svc-project-content`, `svc-serialization` |
...
| `core-space` (rust-foundation) | actual: none<br>allowed: none | 21/0 | none | `core-commands`, `core-events`, `fixture-maker`, `native-bridge`, `protocol-view`, `render-bridge`, `rule-lifecycle`, `rule-project-bundle`, `rule-scheduler`, `rule-voxel-edit`, `runtime-bridge-api`, `scene-diagnostics`, `svc-collision`, `svc-combat`, `svc-environment-authoring`, `svc-levelgen`, `svc-mesh`, `svc-pathfinding`, `svc-spatial`, `svc-volume`, `voxel-diagnostics` |
...
| `gameplay-module-sdk` (rust-rule) | actual: `core-ids`, `core-time`, `game-rule-extension`, `protocol-game-extension`, `rule-gameplay-fabric`, `svc-gameplay-fabric`, `svc-rng`<br>allowed: `core-ids`, `core-time`, `game-rule-extension`, `protocol-game-extension`, `rule-gameplay-fabric`, `svc-gameplay-fabric`, `svc-rng` | 3/7 | none | `gameplay-runtime-host`, `rule-project-bundle`, `runtime-bridge-api`, `role:asha-demo`, `role:asha-testing`, `role:asha-rulebench` |
| `gameplay-runtime-host` (rust-rule) | actual: `core-entity`, `core-ids`, `core-math`, `core-scene`, `gameplay-module-sdk`, `protocol-diagnostics`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-voxel-asset`, `rule-gameplay-fabric`, `rule-project-bundle`, `rule-scheduler`, `rule-trigger-volume`, `svc-entity-authoring`, `svc-gameplay-fabric`, `svc-project-content`, `svc-serialization`, `svc-voxel-asset`<br>allowed: `core-entity`, `core-ids`, `core-math`, `core-scene`, `gameplay-module-sdk`, `protocol-diagnostics`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-voxel-asset`, `rule-gameplay-fabric`, `rule-project-bundle`, `rule-scheduler`, `rule-trigger-volume`, `svc-entity-authoring`, `svc-gameplay-fabric`, `svc-project-content`, `svc-serialization`, `svc-voxel-asset` | 1/20 | none | `runtime-bridge-api`, `role:asha-demo`, `role:asha-testing`, `role:asha-rulebench` |
| `native-bridge` (rust-bridge) | actual: `core-ids`, `core-math`, `core-space`, `core-voxel`, `protocol-assets`, `protocol-diagnostics`, `protocol-game-extension`, `protocol-render`, `protocol-scene`, `protocol-view`, `protocol-voxel-asset`, `render-bridge`, `runtime-bridge-api`<br>allowed: `core-ids`, `core-math`, `core-space`, `core-voxel`, `protocol-assets`, `protocol-diagnostics`, `protocol-game-extension`, `protocol-render`, `protocol-replay`, `protocol-scene`, `protocol-script`, `protocol-view`, `protocol-voxel-asset`, `render-bridge`, `runtime-bridge-api`, `sim-runner` | 0/13 | none | `role:asha-demo`, `role:asha-testing`, `role:asha-rulebench` |
| `protocol-assets` (contract-steward) | actual: `core-assets`, `core-ids`<br>allowed: `core-assets`, `core-ids` | 6/2 | none | `native-bridge`, `protocol-codegen`, `protocol-project-content`, `protocol-render`, `runtime-bridge-api`, `svc-project-content` |
| `protocol-codegen` (contract-steward) | actual: `core-ids`, `protocol-assets`, `protocol-diagnostics`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-game-rules`, `protocol-ids`, `protocol-input`, `protocol-policy-view`, `protocol-presentation`, `protocol-project-bundle`, `protocol-project-content`, `protocol-render`, `protocol-replay`, `protocol-scene`, `protocol-telemetry`, `protocol-time-control`, `protocol-view`, `protocol-voxel-annotation`, `protocol-voxel-asset`, `protocol-voxel-conversion`, `protocol-voxel-edit-history`<br>allowed: `core-ids`, `protocol-assets`, `protocol-diagnostics`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-game-rules`, `protocol-ids`, `protocol-input`, `protocol-policy-view`, `protocol-presentation`, `protocol-project-bundle`, `protocol-project-content`, `protocol-render`, `protocol-replay`, `protocol-scene`, `protocol-script`, `protocol-telemetry`, `protocol-time-control`, `protocol-view`, `protocol-voxel-annotation`, `protocol-voxel-asset`, `protocol-voxel-conversion`, `protocol-voxel-edit-history` | 1/22 | none | `protocol-dump` |
| `protocol-diagnostics` (contract-steward) | actual: none<br>allowed: none | 18/0 | none | `game-rule-extension`, `gameplay-runtime-host`, `native-bridge`, `protocol-codegen`, `protocol-game-extension`, `protocol-game-rules`, `protocol-voxel-annotation`, `protocol-voxel-asset`, `protocol-voxel-conversion`, `protocol-voxel-edit-history`, `rule-project-bundle`, `runtime-bridge-api`, `scene-diagnostics`, `svc-game-rules`, `svc-gameplay-fabric`, `svc-voxel-annotation`, `svc-voxel-asset`, `svc-voxel-conversion` |
...
| `protocol-entity-authoring` (contract-steward) | actual: `core-ids`<br>allowed: `core-ids` | 7/1 | none | `gameplay-runtime-host`, `protocol-codegen`, `protocol-project-content`, `rule-lifecycle`, `runtime-bridge-api`, `svc-entity-authoring`, `svc-project-content` |
| `protocol-game-extension` (contract-steward) | actual: `core-ids`, `protocol-diagnostics`, `protocol-project-bundle`<br>allowed: `core-ids`, `protocol-diagnostics`, `protocol-project-bundle` | 13/3 | none | `game-rule-extension`, `gameplay-module-sdk`, `gameplay-runtime-host`, `native-bridge`, `protocol-codegen`, `protocol-project-content`, `rule-gameplay-fabric`, `rule-lifecycle`, `rule-project-bundle`, `rule-scheduler`, `runtime-bridge-api`, `svc-gameplay-fabric`, `svc-project-content` |
...
| `protocol-project-bundle` (contract-steward) | actual: `core-ids`<br>allowed: `core-ids` | 8/1 | none | `gameplay-runtime-host`, `protocol-codegen`, `protocol-game-extension`, `protocol-project-content`, `rule-gameplay-fabric`, `rule-project-bundle`, `runtime-bridge-api`, `svc-project-content` |
| `protocol-project-content` (contract-steward) | actual: `core-ids`, `protocol-assets`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-render`, `protocol-scene`, `protocol-voxel-asset`<br>allowed: `core-ids`, `protocol-assets`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-render`, `protocol-scene`, `protocol-voxel-asset` | 6/8 | none | `gameplay-runtime-host`, `protocol-codegen`, `rule-project-bundle`, `runtime-bridge-api`, `svc-environment-authoring`, `svc-project-content` |
| `protocol-render` (contract-steward) | actual: `core-ids`, `protocol-assets`<br>allowed: `core-error`, `core-ids`, `protocol-assets` | 10/2 | none | `asset-import`, `native-bridge`, `protocol-codegen`, `protocol-presentation`, `protocol-project-content`, `render-animation`, `render-audio`, `render-bridge`, `render-debug`, `runtime-bridge-api` |
...
| `protocol-voxel-asset` (contract-steward) | actual: `protocol-diagnostics`<br>allowed: `protocol-diagnostics` | 7/1 | none | `gameplay-runtime-host`, `native-bridge`, `protocol-codegen`, `protocol-project-content`, `runtime-bridge-api`, `svc-environment-authoring`, `svc-voxel-asset` |
...
| `rule-project-bundle` (rust-rule) | actual: `core-assets`, `core-entity`, `core-events`, `core-ids`, `core-math`, `core-scene`, `core-space`, `core-voxel`, `gameplay-module-sdk`, `protocol-diagnostics`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-voxel-annotation`, `rule-gameplay-fabric`, `rule-trigger-volume`, `rule-voxel-edit`, `svc-gameplay-fabric`, `svc-project-content`, `svc-serialization`, `svc-spatial`, `svc-volume`, `svc-voxel-annotation`<br>allowed: `core-assets`, `core-entity`, `core-events`, `core-ids`, `core-math`, `core-scene`, `core-space`, `core-voxel`, `gameplay-module-sdk`, `protocol-diagnostics`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-voxel-annotation`, `rule-gameplay-fabric`, `rule-trigger-volume`, `rule-voxel-edit`, `svc-gameplay-fabric`, `svc-project-content`, `svc-serialization`, `svc-spatial`, `svc-volume`, `svc-voxel-annotation` | 3/23 | none | `gameplay-runtime-host`, `runtime-bridge-api`, `scene-diagnostics`, `role:asha-demo`, `role:asha-testing`, `role:asha-rulebench` |
...
| `svc-collision` (rust-service) | actual: `core-space`, `core-voxel`, `svc-spatial`, `svc-volume`<br>allowed: `core-error`, `core-ids`, `core-math`, `core-space`, `core-voxel`, `svc-spatial`, `svc-volume` | 8/4 | none | `fixture-maker`, `rule-lifecycle`, `rule-voxel-edit`, `runtime-bridge-api`, `svc-combat`, `svc-environment-authoring`, `svc-levelgen`, `voxel-diagnostics` |
...
| `svc-entity-authoring` (rust-service) | actual: `core-assets`, `core-entity`, `core-ids`, `core-math`, `protocol-entity-authoring`<br>allowed: `core-assets`, `core-entity`, `core-ids`, `core-math`, `protocol-entity-authoring` | 3/5 | none | `gameplay-runtime-host`, `rule-lifecycle`, `svc-project-content` |
| `svc-environment-authoring` (rust-service) | actual: `core-assets`, `core-ids`, `core-math`, `core-scene`, `core-space`, `protocol-project-content`, `protocol-voxel-asset`, `svc-collision`, `svc-levelgen`, `svc-pathfinding`, `svc-serialization`, `svc-spatial`, `svc-voxel-asset`<br>allowed: `core-assets`, `core-ids`, `core-math`, `core-scene`, `core-space`, `protocol-project-content`, `protocol-voxel-asset`, `svc-collision`, `svc-levelgen`, `svc-pathfinding`, `svc-serialization`, `svc-spatial`, `svc-voxel-asset` | 1/13 | none | `runtime-bridge-api` |
...
| `svc-levelgen` (rust-service) | actual: `core-events`, `core-space`, `core-voxel`, `svc-collision`, `svc-rng`, `svc-spatial`, `svc-volume`<br>allowed: `core-events`, `core-space`, `core-voxel`, `svc-collision`, `svc-rng`, `svc-spatial`, `svc-volume` | 6/7 | none | `render-bridge`, `rule-lifecycle`, `runtime-bridge-api`, `svc-combat`, `svc-environment-authoring`, `svc-pathfinding` |
...
| `svc-pathfinding` (rust-service) | actual: `core-math`, `core-space`, `core-voxel`, `svc-levelgen`, `svc-spatial`, `svc-volume`<br>allowed: `core-math`, `core-space`, `core-voxel`, `svc-levelgen`, `svc-spatial`, `svc-volume` | 3/6 | none | `rule-lifecycle`, `runtime-bridge-api`, `svc-environment-authoring` |
...
| `svc-project-content` (rust-service) | actual: `core-assets`, `core-catalog`, `core-ids`, `core-scene`, `protocol-assets`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-scene`, `svc-entity-authoring`, `svc-serialization`<br>allowed: `core-assets`, `core-catalog`, `core-ids`, `core-scene`, `protocol-assets`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-scene`, `svc-entity-authoring`, `svc-serialization` | 3/12 | none | `gameplay-runtime-host`, `rule-project-bundle`, `runtime-bridge-api` |
| `svc-rng` (rust-service) | actual: none<br>allowed: `core-error`, `core-ids` | 2/0 | none | `gameplay-module-sdk`, `svc-levelgen` |
| `svc-serialization` (rust-service) | actual: `core-assets`, `core-error`, `core-ids`, `core-scene`<br>allowed: `core-assets`, `core-error`, `core-ids`, `core-scene` | 8/4 | none | `fixture-maker`, `gameplay-runtime-host`, `rule-gameplay-fabric`, `rule-project-bundle`, `runtime-bridge-api`, `scene-diagnostics`, `svc-environment-authoring`, `svc-project-content` |
| `svc-spatial` (rust-service) | actual: `core-space`, `core-voxel`, `svc-volume`<br>allowed: `core-error`, `core-ids`, `core-math`, `core-space`, `core-voxel`, `svc-volume` | 12/3 | none | `fixture-maker`, `render-bridge`, `rule-project-bundle`, `rule-voxel-edit`, `runtime-bridge-api`, `scene-diagnostics`, `svc-collision`, `svc-environment-authoring`, `svc-levelgen`, `svc-mesh`, `svc-pathfinding`, `voxel-diagnostics` |
...
| `svc-voxel-asset` (rust-service) | actual: `core-assets`, `protocol-diagnostics`, `protocol-voxel-asset`<br>allowed: `core-assets`, `protocol-diagnostics`, `protocol-voxel-asset` | 3/3 | none | `gameplay-runtime-host`, `runtime-bridge-api`, `svc-environment-authoring` |
...
| Cell | Actual edges / allowed edges | Fan in/out | Cycle risk | Public consumers |
|---|---|---:|---|---|
| `@asha/app` (ts-shell) | actual: `@asha/contracts`, `@asha/devtools`, `@asha/editor-tools`, `@asha/game-workspace`, `@asha/renderer-three`, `@asha/runtime-bridge`, `@asha/runtime-session`, `@asha/script-host`, `@asha/ui-dom`<br>allowed: `@asha/contracts`, `@asha/devtools`, `@asha/editor-tools`, `@asha/game-workspace`, `@asha/renderer-three`, `@asha/runtime-bridge`, `@asha/runtime-session`, `@asha/script-host`, `@asha/ui-dom` | 1/9 | none | `@asha/smoke` |
| `@asha/browser-host` (ts-shell) | actual: `@asha/contracts`, `@asha/game-workspace`, `@asha/runtime-bridge`<br>allowed: `@asha/contracts`, `@asha/game-workspace`, `@asha/runtime-bridge` | 1/3 | none | `@asha/smoke`, `role:asha-demo`, `role:asha-studio` |
...
| `@asha/contracts` (contract-steward) | actual: none<br>allowed: none | 22/0 | none | `@asha/app`, `@asha/browser-host`, `@asha/catalog-core`, `@asha/catalog-examples`, `@asha/command-registry`, `@asha/cosmetic`, `@asha/devtools`, `@asha/editor-tools`, `@asha/game-workspace`, `@asha/native-bridge`, `@asha/policy-core`, `@asha/policy-examples`, `@asha/render-projection`, `@asha/renderer-host`, `@asha/renderer-three`, `@asha/runtime-bridge`, `@asha/runtime-session`, `@asha/script-host`, `@asha/script-sdk`, `@asha/smoke`, `@asha/ui-dom`, `@asha/wasm-replay-bridge`, `role:asha-testing`, `role:asha-demo`, `role:asha-studio`, `role:downstream-authoring`, `role:downstream-visual-authoring` |
...
| `@asha/game-workspace` (ts-game-workspace) | actual: `@asha/contracts`<br>allowed: `@asha/contracts` | 4/1 | none | `@asha/app`, `@asha/browser-host`, `@asha/runtime-bridge`, `@asha/smoke`, `role:asha-testing`, `role:asha-demo`, `role:asha-studio`, `role:downstream-authoring`, `role:downstream-visual-authoring` |
...
| `@asha/renderer-host` (ts-shell) | actual: `@asha/contracts`, `@asha/render-projection`, `@asha/renderer-three`, `@asha/runtime-bridge`<br>allowed: `@asha/contracts`, `@asha/render-projection`, `@asha/renderer-three`, `@asha/runtime-bridge` | 1/4 | none | `@asha/smoke`, `role:asha-demo`, `role:asha-studio`, `role:downstream-visual-authoring` |
| `@asha/renderer-three` (ts-shell) | actual: `@asha/contracts`, `@asha/render-projection`, `@asha/runtime-bridge`, `@asha/runtime-session`<br>allowed: `@asha/contracts`, `@asha/render-projection`, `@asha/runtime-bridge`, `@asha/runtime-session` | 3/4 | none | `@asha/app`, `@asha/renderer-host`, `@asha/smoke`, `role:asha-testing` |
| `@asha/runtime-bridge` (ts-shell) | actual: `@asha/contracts`, `@asha/game-workspace`, `@asha/native-bridge`, `@asha/runtime-session`<br>allowed: `@asha/contracts`, `@asha/game-workspace`, `@asha/native-bridge`, `@asha/runtime-session` | 7/4 | none | `@asha/app`, `@asha/browser-host`, `@asha/devtools`, `@asha/renderer-host`, `@asha/renderer-three`, `@asha/smoke`, `@asha/ui-dom`, `role:asha-testing`, `role:asha-demo`, `role:asha-studio`, `role:downstream-authoring`, `role:downstream-visual-authoring` |
| `@asha/runtime-session` (ts-shell) | actual: `@asha/contracts`<br>allowed: `@asha/contracts` | 4/1 | none | `@asha/app`, `@asha/renderer-three`, `@asha/runtime-bridge`, `@asha/smoke`, `role:asha-testing`, `role:asha-demo`, `role:asha-studio`, `role:downstream-authoring`, `role:downstream-visual-authoring` |
...
| `@asha/smoke` (ts-shell) | actual: `@asha/app`, `@asha/browser-host`, `@asha/catalog-core`, `@asha/command-registry`, `@asha/contracts`, `@asha/editor-tools`, `@asha/game-workspace`, `@asha/renderer-host`, `@asha/renderer-three`, `@asha/runtime-bridge`, `@asha/runtime-session`, `@asha/ui-dom`<br>allowed: `@asha/app`, `@asha/browser-host`, `@asha/catalog-core`, `@asha/command-registry`, `@asha/contracts`, `@asha/editor-tools`, `@asha/game-workspace`, `@asha/renderer-host`, `@asha/renderer-three`, `@asha/runtime-bridge`, `@asha/runtime-session`, `@asha/ui-dom` | 0/12 | none | none |
...
| `engine-rs/crates/bridge/runtime-bridge-api/src/authority/runtime_bridge_impl.rs` | 1743 / 1570 / 1621 | rust-bridge | 2026-10-15 |
...
| `engine-rs/crates/rules/gameplay-runtime-host/src/lib.rs` | 3131 / 2950 / 3036 | rust-rule | 2026-09-15 |
...
| `engine-rs/crates/protocol/protocol-codegen/src/source.rs` | 1566 / 1400 / 1600 | contract-steward | global policy |
| `engine-rs/crates/rules/rule-animation-controller/src/lib.rs` | 1565 / 1400 / 1600 | rust-rule | global policy |
| `ts/packages/runtime-bridge/src/mock.ts` | 1583 / 1580 / 1620 | ts-shell | 2026-10-15 |
...
- [`harness/fixtures/canonical-project-consumer`](../../harness/fixtures/canonical-project-consumer) — 15 files
- [`harness/fixtures/canonical-project-loader`](../../harness/fixtures/canonical-project-loader) — 3 files
...
- [`harness/fixtures/composed-native-provider`](../../harness/fixtures/composed-native-provider) — 4 files
...
- [`harness/fixtures/gameplay-module-sdk`](../../harness/fixtures/gameplay-module-sdk) — 6 files
...
- [`harness/fixtures/scenes`](../../harness/fixtures/scenes) — 7 files
...
- [`harness/fixtures/spatial-grid`](../../harness/fixtures/spatial-grid) — 1 files
