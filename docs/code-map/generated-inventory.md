...
Committed path classes: 752 source; 27 generated source; 524 other; 0 build/cache/output.
...
| `core-scene` (rust-state) | actual: `core-assets`, `core-entity`, `core-error`, `core-ids`, `core-math`<br>allowed: `core-assets`, `core-entity`, `core-error`, `core-ids`, `core-math` | 8/5 | none | `gameplay-runtime-host`, `render-bridge`, `rule-project-bundle`, `rule-voxel-edit`, `runtime-bridge-api`, `scene-diagnostics`, `svc-environment-authoring`, `svc-serialization` |
...
| `protocol-voxel-asset` (contract-steward) | actual: `protocol-diagnostics`<br>allowed: `protocol-diagnostics` | 6/1 | none | `native-bridge`, `protocol-codegen`, `protocol-project-content`, `runtime-bridge-api`, `svc-environment-authoring`, `svc-voxel-asset` |
...
| `svc-project-content` (rust-service) | actual: `core-assets`, `core-catalog`, `core-ids`, `protocol-assets`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-scene`, `svc-entity-authoring`, `svc-serialization`<br>allowed: `core-assets`, `core-catalog`, `core-ids`, `protocol-assets`, `protocol-entity-authoring`, `protocol-game-extension`, `protocol-project-bundle`, `protocol-project-content`, `protocol-scene`, `svc-entity-authoring`, `svc-serialization` | 2/11 | none | `rule-project-bundle`, `runtime-bridge-api` |
...
| `svc-voxel-asset` (rust-service) | actual: `core-assets`, `protocol-diagnostics`, `protocol-voxel-asset`<br>allowed: `core-assets`, `protocol-diagnostics`, `protocol-voxel-asset` | 2/3 | none | `runtime-bridge-api`, `svc-environment-authoring` |
...
|---|---:|---|---|
| `engine-rs/crates/bridge/runtime-bridge-api/src/authority/runtime_bridge_impl.rs` | 1705 / 1570 / 1621 | rust-bridge | 2026-10-15 |
| `engine-rs/crates/rules/gameplay-runtime-host/src/lib.rs` | 3164 / 2950 / 3036 | rust-rule | 2026-09-15 |
| `ts/packages/runtime-bridge/src/mock.ts` | 1661 / 1580 / 1620 | ts-shell | 2026-10-15 |
...
| `ts/packages/runtime-bridge/src/runtime-session.test.ts` | 1584 / 1400 / 1600 | ts-shell | global policy |
...
| `ts/packages/runtime-bridge/src/runtime-session-rust-facade.ts` | 1575 / 1400 / 1600 | ts-shell | global policy |
...
| `engine-rs/crates/protocol/protocol-codegen/src/source.rs` | 1561 / 1400 / 1600 | contract-steward | global policy |
