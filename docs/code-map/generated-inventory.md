...
| `protocol-project-bundle` (contract-steward) | actual: `core-ids`<br>allowed: `core-ids` | 9/1 | none | `gameplay-runtime-host`, `native-bridge`, `protocol-codegen`, `protocol-game-extension`, `protocol-project-content`, `rule-gameplay-fabric`, `rule-project-bundle`, `runtime-bridge-api`, `svc-project-content` |
