...
import { projectId, sceneId, runtimeSessionId, } from '@asha/contracts';
...
void test('navigateSource resolves the most specific available locus', () => {
    ...
    assert.deepEqual(navigateSource({ sceneNodeId: null, runtimeEntityId: null, assetId: 'mesh:x', chunkCoord: null, renderHandle: null, bundlePath: 'b.json' }), { kind: 'asset', assetId: 'mesh:x' });
