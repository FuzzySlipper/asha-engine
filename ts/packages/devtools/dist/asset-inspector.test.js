...
import { buildCatalogModel, buildLockDriftModel, classifyFallback, impactOfChangedAsset, inspectMaterial, } from './asset-inspector.js';
function ref(id) {
...
import { buildAssetSourceTrace, formatAssetSourceTrace, } from './asset-inspector.js';
function trace(over) {
    return {
...
//# sourceMappingURL=asset-inspector.test.js.map