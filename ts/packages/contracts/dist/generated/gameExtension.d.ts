...
export declare const GAMEPLAY_MODULE_BINDING_SCHEMA_VERSION = 1;
...
export type GameplayModuleBindingTarget = {
    ...
    readonly kind: 'prefabPart';
    readonly part: PrefabPartReference;
};
...
export type GameplayRegistryValidationOutcome = {
    ...
    readonly readout: GameplayRegistryReadout;
} | {
    readonly status: 'invalid';
    readonly diagnostics: readonly GameplayRegistryDiagnostic[];
};
