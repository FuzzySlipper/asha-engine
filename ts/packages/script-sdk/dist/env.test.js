...
test('DeterministicRng is reproducible for a given seed', () => {
...
test('nextFloat is in [0, 1) and nextInRange respects bounds', () => {
...
test('makeEnv carries tick, seed, and a seeded stream', () => {
...
test('a negative or non-integer seed is rejected, never silently coerced', () => {
