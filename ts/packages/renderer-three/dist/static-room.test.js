...
void test('committed static-room fixture matches the public helper and golden snapshot', () => {
    ...
    const golden = readFileSync(resolve(repoRoot, 'harness/goldens/render-diffs', `${STATIC_ROOM_FIXTURE_NAME}.snapshot`), 'utf8');
    assert.equal(renderer.snapshot(), golden);
});
//# sourceMappingURL=static-room.test.js.map