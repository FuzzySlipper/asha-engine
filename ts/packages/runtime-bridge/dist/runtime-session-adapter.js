...
import { GENERATED_TUNNEL_FIRE_HIT_READOUT, GENERATED_TUNNEL_FIRE_MISS_READOUT, } from '@asha/runtime-session';
import { buildCombatFeedbackProjection, defaultCombatFeedbackIntent, } from '@asha/runtime-session';
...
import { buildEncounterDirectorReadout, buildEncounterTransitionReceipt, initialEncounterDirectorState, transitionEncounterDirectorState, validateEncounterDirectorReadoutRequest, validateEncounterTransitionRequest, } from '@asha/runtime-session';
import { GENERATED_TUNNEL_NAV_POLICY_VIEW, GENERATED_TUNNEL_NAV_PROJECTION, GENERATED_TUNNEL_NO_PATH, GENERATED_TUNNEL_REACHABLE_PATH, } from '@asha/runtime-session';
...
class ReferenceRuntimeSessionFacade {
    ...
    initializeVoxelVolumeAuthoring(_request) { void _request; return this.#unsupportedOperation('initializeVoxelVolumeAuthoring', 'Voxel volume authoring initialization is not wired into the reference RuntimeSession'); }
    ...
    unloadVoxelVolumeAsset(_request) { void _request; return this.#unsupportedOperation('unloadVoxelVolumeAsset', 'Voxel volume asset unload is not wired into the reference RuntimeSession'); }
...
//# sourceMappingURL=runtime-session-adapter.js.map