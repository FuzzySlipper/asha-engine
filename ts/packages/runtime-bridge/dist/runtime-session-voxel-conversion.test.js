...
function voxelConversionSourceRegistrationRequest() {
    return {
...
function voxelConversionPreview(request) {
...
function voxelConversionReceipt(request) {
...
function createVoxelConversionBridge() {
...
void test('reference RuntimeSession voxel conversion facade methods remain typed and fail closed', () => {
    ...
    assert.throws(() => referenceSession.readVoxelModelWindow({
        grid: 1,
        volumeAssetId: 'voxel/generated',
        bounds: { min: { x: 0, y: 0, z: 0 }, max: { x: 0, y: 0, z: 0 } },
        includeEmpty: false,
    ...
    assert.throws(() => referenceSession.exportVoxelVolumeAsset({
        grid: 1,
        volumeAssetId: 'voxel/generated',
    ...
    assert.throws(() => referenceSession.loadVoxelVolumeAsset({
        asset: {
