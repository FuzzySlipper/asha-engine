...
import { RuntimeBridgeError, createRuntimeSessionFacade, readRuntimeSessionPlayableEncounterTick, readRuntimeSessionPlayableLoopState, } from './index.js';
...
void test('RuntimeSession exposes bounded game-rules validation, submit, and readout surfaces', () => {
    ...
    const catalog = {
        ...
        bundles: [{
                ...
                effectOps: [
                    { kind: 'applyDelta', opId: 'op.impact-damage', channelId: 'value.health', amount: -4, tags: ['tag.impact'] },
                    {
