        ...
        entityDefinitions: [
            {
                ...
                capabilities: [
                    ...
                    { kind: 'health', current: 88, max: 88 },
                    { kind: 'renderProjection', projection: 'first_person_camera' },
                    { kind: 'controller', controller: 'player_input' },
                    { kind: 'faction', factionId: 'player' },
                ],
            },
            {
                kind: 'EntityDefinition',
                ...
                capabilities: [
                    ...
                    { kind: 'health', current: 55, max: 55 },
                    { kind: 'renderProjection', projection: 'target_cube' },
                    { kind: 'policyBinding', policyId: 'policy.enemy.custom.v0' },
                    { kind: 'faction', factionId: 'hostile' },
                ],
            },
        ],
        sceneDocument: {
...
//# sourceMappingURL=runtime-session-game-rule-load.test.js.map