...
export declare class MockRuntimeBridge implements RuntimeBridge {
    ...
    importVoxelConversionMeshSource(_request: VoxelConversionMeshSourceImportRequest): VoxelConversionMeshSourceImportReceipt;
    readVoxelConversionSourceMetadata(_request: VoxelConversionSourceMetadataRequest): VoxelConversionSourceMetadataReadout;
    ...
    updateVoxelVolumeAssetPalette(_request: VoxelVolumeAssetPaletteUpdateRequest): VoxelVolumeAssetPaletteUpdateReceipt;
    initializeVoxelVolumeAuthoring(_request: VoxelVolumeAuthoringInitializeRequest): VoxelVolumeAuthoringInitializeReceipt;
    loadVoxelVolumeAsset(_request: VoxelVolumeAssetLoadRequest): VoxelVolumeAssetLoadReceipt;
    unloadVoxelVolumeAsset(_request: VoxelVolumeAssetUnloadRequest): VoxelVolumeAssetUnloadReceipt;
