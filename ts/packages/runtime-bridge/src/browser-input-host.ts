...
export function createDefaultBrowserInputCatalog(): InputBindingCatalog {
  ...
  return {
    ...
    actions: [
      ...
      { actionId: 'runtime.session.restart', valueKind: 'button', acceptedPhases: ['pressed'] },
    ...
    bindings: [
      ...
      binding('gameplay-restart', 'runtime.session.restart', 'gameplay', 'keyboardKey', 'KeyR'),
      ...
      binding('menu-restart', 'runtime.session.restart', 'menu', 'keyboardKey', 'KeyR'),
