...
export const MANIFEST_OPERATIONS: readonly BridgeOperation[] = [
  ...
  { manifestName: 'load_world_bundle', facadeMethod: 'loadProjectBundle', surface: 'stable' },
  { manifestName: 'save_current_world', facadeMethod: 'saveProjectBundle', surface: 'stable' },
  { manifestName: 'get_composition_status', facadeMethod: 'getProjectBundleCompositionStatus', surface: 'stable' },
  { manifestName: 'unload_world', facadeMethod: 'unloadProjectBundle', surface: 'stable' },
