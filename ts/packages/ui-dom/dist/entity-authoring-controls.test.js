...
test('control interactions map to typed proposal commands (or null when a param is missing)', () => {
    ...
    assert.equal(entityAuthoringControlToCommand('entity-contain', eid(2), { container: eid(3) })?.kind, 'setContainment');
...
//# sourceMappingURL=entity-authoring-controls.test.js.map