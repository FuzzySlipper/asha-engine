...
import type { RuntimeSessionCommandReceipt, RuntimeSessionInitializeInput, RuntimeSessionProjectionSummary, RuntimeSessionStateSummary, RuntimeSessionTelemetrySummary, RuntimeSessionTickInput, RuntimeSessionTickResult } from './facade-core.js';
import type { RuntimeSessionEcrpProjectLoadInput, RuntimeSessionEcrpProjectLoadReceipt, RuntimeSessionEcrpReadout } from './facade-ecrp.js';
import type { RuntimeSessionActionIntentReceipt, RuntimeSessionAnimationIntentReadout, RuntimeSessionAutonomousPolicyTickInput, RuntimeSessionAutonomousPolicyTickReadout, RuntimeSessionCameraCollisionInputReceipt, RuntimeSessionCameraCreateReceipt, RuntimeSessionCameraInputReceipt, RuntimeSessionCameraProjectionReadout, RuntimeSessionCombatFeedbackProjectionRequest, RuntimeSessionCombatReadoutRequest, RuntimeSessionGameExtensionWeaponEffectReceipt, RuntimeSessionGameRuleCatalogValidationReceipt, RuntimeSessionGameRuleEffectIntentReceipt, RuntimeSessionGeneratedTunnelOperationReceipt } from './facade-gameplay.js';
import type { RuntimeSessionLifecycleRestartReceipt, RuntimeSessionLifecycleStatusReadout, RuntimeSessionLifecycleStatusRequest, RuntimeSessionRestartIntent, RuntimeSessionRestartResult } from './facade-lifecycle.js';
