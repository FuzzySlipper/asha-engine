...
CONTRACT_WIRE_MODULES = {
    ...
    "ProjectWritePrepareRequest": "projectBundle",
    "ProjectWritePrepareReceipt": "projectBundle",
    "ProjectWriteConfirmRequest": "projectBundle",
    "ProjectWriteConfirmReceipt": "projectBundle",
...
def native_wired(operation: dict[str, Any]) -> bool:
    return operation.get("native_wired", operation["surface"] == "stable")
...
def emit_operations_ts(
    ...
    for operation in operations:
        ...
        lines.append(f"    nativeWired: {str(native_wired(operation)).lower()},")
...
def emit_native_surface_ts(operations: list[dict[str, Any]]) -> str:
    stable_methods = [facade_method(operation) for operation in operations if native_wired(operation)]
        ...
        "operations": [
            {
                ...
                "nativeWired": native_wired(operation),
...
def emit_rust_native_exports(
    ...
    stable = [operation for operation in operations if native_wired(operation)]
    lines = [
        RUST_BANNER,
        "#![allow(dead_code)]",
        "",
