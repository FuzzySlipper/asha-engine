...
mod tests {
    ...
    fn rust_round_trip_sample_coverage() -> BTreeSet<String> {
        let mut coverage = [
            ...
            interface_coverage_key("render", "AnimatedMeshAsset"),
            variant_coverage_key("render", "AnimatedMeshPlaybackCommand", "play"),
            variant_coverage_key("render", "AnimatedMeshPlaybackCommand", "stop"),
            variant_coverage_key("render", "AnimatedMeshPlaybackCommand", "pause"),
            variant_coverage_key("render", "AnimatedMeshPlaybackCommand", "resume"),
            interface_coverage_key("render", "AnimatedMeshInstanceDescriptor"),
            variant_coverage_key("render", "RenderDiff", "defineAnimatedMesh"),
            variant_coverage_key("render", "RenderDiff", "createAnimatedMeshInstance"),
            variant_coverage_key("render", "RenderDiff", "setAnimatedMeshPlayback"),
            ...
            interface_coverage_key("voxelAsset", "VoxelVolumeAssetUnloadReceipt"),
    ...
    fn rust_round_trip_coverage_exemptions() -> BTreeMap<&'static str, &'static str> {
        ...
        exempt_items(
            ...
            &[
                ...
                "scene.SceneEntityReference.entityDefinition",
                "scene.SceneEntityReference.prefab",
                "scene.SceneEntityInstance",
                "scene.SceneGeneratorBinding",
                "scene.SceneCatalogBinding",
                "scene.SceneBootstrapBindings",
                "scene.SceneNodeKind.entityInstance",
                "scene.SceneNodeKind.bootstrap",
                ...
                "scene.SceneResolvedEntityInstance",
        ...
        exempt_items(
            ...
            &[
                ...
                "entityAuthoring.EntityDefinitionCapability.controller",
                "entityAuthoring.EntityDefinitionCapability.health",
                "entityAuthoring.EntityDefinitionCapability.weaponMount",
                "entityAuthoring.EntityDefinitionCapability.renderProjection",
                "entityAuthoring.EntityDefinitionCapability.policyBinding",
                "entityAuthoring.EntityDefinitionCapability.spawnMarker",
                "entityAuthoring.EntityDefinitionCapability.faction",
    ...
    fn voxel_asset_family_emits_storage_contract() {
        ...
        assert!(va.contains("readonly removedVoxelCount: number;"));
    }
