...
const MODULE_PLANS: &[ModulePlan] = &[
    ...
    ModulePlan {
        ...
        declarations: "brand:CameraHandle type:CameraPose type:CameraBasis type:PerspectiveProjection type:ViewportSize type:CameraCreateRequest type:FirstPersonCameraInput type:FirstPersonCameraInputEnvelope type:CameraProjectionRequest type:CameraSnapshot type:CameraProjectionSnapshot type:CameraCollisionShape type:CameraCollisionPolicyMode type:CameraCollisionPolicy type:GeneratedTunnelPreset type:GeneratedTunnelRuntimeApplyRequest type:GeneratedTunnelRuntimeApplyReceipt type:CollisionConstrainedCameraInputEnvelope type:CollisionAabbEvidence type:CollisionAxis type:CameraCollisionEvidence type:CameraCollisionSnapshot type:ScreenPointSpace type:ScreenPoint type:ScreenPointToPickRayRequest type:PickRaySnapshot type:VoxelSelectionOutcome type:VoxelSelectionSnapshot",
    },
    ModulePlan {
