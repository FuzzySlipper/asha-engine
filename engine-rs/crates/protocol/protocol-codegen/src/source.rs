...
const MODULE_PLANS: &[ModulePlan] = &[
    ...
    ModulePlan {
        ...
        declarations: "brand:ProjectId brand:SceneId brand:RuntimeSessionId brand:SceneNodeId type:SceneNodeKindTag enumconst:SceneValidationCode:SCENE_VALIDATION_CODES enumconst:SceneObjectCommandRejectionCode:SCENE_OBJECT_COMMAND_REJECTION_CODES enumconst:SceneDocumentCodecDiagnosticCode:SCENE_DOCUMENT_CODEC_DIAGNOSTIC_CODES enumconst:SceneDocumentAuthoringRejectionCode:SCENE_DOCUMENT_AUTHORING_REJECTION_CODES type:AssetVersionReq:AssetVersionReqDto:req type:AssetReference:AssetReferenceDto type:SceneTransform:SceneTransformDto type:SceneLightShadowIntent:SceneLightShadowIntentDto type:SceneLight:SceneLightDto:kind type:SceneEntityReference:SceneEntityReferenceDto:kind type:SceneEntityInstance:SceneEntityInstanceDto type:SceneMarker:SceneMarkerDto type:SceneGeneratorBinding:SceneGeneratorBindingDto type:SceneCatalogBinding:SceneCatalogBindingDto type:SceneBootstrapBindings:SceneBootstrapBindingsDto type:SceneNodeKind:SceneNodeKindDto:kind type:SceneNodeRecord:SceneNodeRecordDto type:SceneMetadata:SceneMetadataDto type:FlatSceneDocument:FlatSceneDocumentDto type:SceneDocumentDecodeRequest:SceneDocumentDecodeRequestDto type:SceneDocumentEncodeRequest:SceneDocumentEncodeRequestDto type:SceneDocumentCodecDiagnostic:SceneDocumentCodecDiagnosticDto type:SceneDocumentCodecResult:SceneDocumentCodecResultDto type:SceneDocumentAuthoringTarget:SceneDocumentAuthoringTargetDto type:SceneDocumentAuthoringCommand:SceneDocumentAuthoringCommandDto:kind type:SceneDocumentAuthoringRequest:SceneDocumentAuthoringRequestDto type:SceneDocumentAuthoringRejection:SceneDocumentAuthoringRejectionDto type:SceneDocumentAuthoringResult:SceneDocumentAuthoringResultDto type:SceneValidationError:SceneValidationErrorDto type:SceneValidationReport:SceneValidationReportDto type:SceneObjectRecord:SceneObjectRecordDto type:SceneObjectSnapshot:SceneObjectSnapshotDto type:SceneObjectCommand:SceneObjectCommandDto:kind type:SceneObjectCommandRejection:SceneObjectCommandRejectionDto type:SceneObjectCommandOutcome:SceneObjectCommandOutcomeDto type:SceneObjectCommandRequest:SceneObjectCommandRequestDto type:SceneObjectCommandResult:SceneObjectCommandResultDto type:SceneSourceTrace:SceneSourceTraceDto type:SceneResolvedEntityInstance:SceneResolvedEntityInstanceDto type:BootstrapRecord:BootstrapRecordDto",
    },
    ModulePlan {
        name: "voxel",
        preferred_paths: &[
    ...
    ModulePlan {
        ...
        declarations: "brand:PrefabId brand:PrefabPartId brand:PrefabInstanceId type:ArtifactClass enumconst:KnownArtifactRole:KNOWN_ARTIFACT_ROLES type:LoadStage type:SuggestedAction type:WorkspaceAuthoringProjectIdentity type:WorkspaceAuthoringProjectBundleRef type:WorkspaceAuthoringCompositionStatus type:WorkspaceAuthoringIdentity type:WorkspaceAuthoringStateSummary type:WorkspaceAuthoringProjectionRequest type:WorkspaceAuthoringProjectionReceipt type:WorkspaceAuthoringStoredConfirmationRequest type:WorkspaceAuthoringStoredConfirmationReceipt type:WorkspaceAuthoringCloseRequest type:WorkspaceAuthoringCloseReceipt type:ArtifactEntry type:GeneratorMetadata type:ProjectSection type:SceneSection type:AssetLockSection type:ProjectBundleManifest enumconst:ProjectSourceBatchErrorCode:PROJECT_SOURCE_BATCH_ERROR_CODES type:StagedProjectResourceRef type:ProjectResourceBeginRequest type:ProjectResourceTransactionReceipt type:ProjectResourceStageRequest type:ProjectSourceBody:ProjectSourceBody:kind type:RuntimeProjectSourceBatch type:ProjectSourceBatchDiagnostic type:ProjectSourceBatchValidationReceipt enumconst:RuntimeProjectSourceAdapterKind:RUNTIME_PROJECT_SOURCE_ADAPTER_KINDS type:RuntimeProjectSourceAdapterInput type:RuntimeProjectLifecycleVersion type:RuntimeProjectLoadRequest enumconst:RuntimeProjectDiagnosticPhase:RUNTIME_PROJECT_DIAGNOSTIC_PHASES type:RuntimeProjectDiagnostic type:RuntimeProjectVoxelBinding type:ActiveRuntimeProjectIdentity type:RuntimeProjectLoadReceipt type:RuntimeProjectCloseRequest type:RuntimeProjectCloseReceipt const:RUNTIME_PROJECT_GAMEPLAY_CHECKPOINT_SCHEMA_VERSION type:RuntimeProjectCheckpointTimeMode type:RuntimeProjectGameplayCheckpoint type:RuntimeProjectGameplayCheckpointSaveRequest type:RuntimeProjectGameplayCheckpointSaveReceipt type:RuntimeProjectGameplayCheckpointRestoreRequest type:RuntimeProjectGameplayCheckpointRestoreReceipt type:ProjectStoreIdentity type:ProjectArtifactExpectation type:ProjectWriteResourceRef type:CanonicalProjectWrite type:CanonicalProjectMove type:CanonicalProjectDelete type:ProjectWriteCandidate type:ProjectWritePublication type:ProjectArtifactRelocation type:ProjectWritePrepareRequest type:ProjectWriteDiagnostic type:ProjectWritePrepareReceipt type:ProjectWriteConfirmRequest type:ProjectWriteConfirmReceipt const:GAMEPLAY_TRIGGER_DEFINITION_SCHEMA_VERSION type:GameplayTriggerDefinition const:PREFAB_REGISTRY_SCHEMA_VERSION const:PREFAB_DEFINITION_SCHEMA_VERSION enumconst:PrefabDiagnosticCode:PREFAB_DIAGNOSTIC_CODES type:PrefabTransform type:PrefabPartSource:PrefabPartSource:kind type:PrefabPart type:PrefabPartRoleBinding type:PrefabOverrideValue:PrefabOverrideValue:field type:PrefabOverride type:PrefabVariantDelta type:PrefabDefinition type:PrefabRegistry type:PrefabInstanceRecord type:PrefabPartReference type:PrefabDiagnostic type:PrefabValidationOutcome:PrefabValidationOutcome:status type:ManifestError:ManifestError:code type:ManifestValidationReport type:LoadStep:LoadStep:step type:LoadPlan type:LoadPlanError:LoadPlanError:code type:CompactionSummary type:SaveSummary type:GeneratorMismatch type:EditConflict type:RegenConflictReport",
    },
    ModulePlan {
        name: "assets",
        preferred_paths: &[
        ...
        declarations: "enumconst:AssetKind:ASSET_KINDS enumconst:StructuralClass:STRUCTURAL_CLASSES enumconst:UvStrategy:UV_STRATEGIES enumconst:CatalogValidationCode:CATALOG_VALIDATION_CODES enumconst:LockIssueCode:LOCK_ISSUE_CODES enumconst:FallbackContext:FALLBACK_CONTEXTS type:FallbackVisual type:Rgba type:RenderMaterial type:CollisionMaterial type:MaterialProjection type:CatalogEntry type:Catalog type:StoredAssetVersionRequirement:StoredAssetVersionRequirement:req type:StoredAssetReference type:StoredMaterialAuthority type:StoredMaterialStyle type:StoredMaterialDefinition type:StoredCatalogEntry type:StoredAssetCatalog type:CatalogValidationError type:CatalogValidationReport type:AssetLockEntry type:AssetLock type:LockFinding type:LockValidationReport type:FallbackDecision:FallbackDecision:outcome",
    },
    ModulePlan {
        name: "projectContent",
        preferred_paths: &["protocol/protocol-project-content"],
        imports: &[
            ("./entityAuthoring.js", "EntityDefinition"),
            ("./assets.js", "StoredAssetCatalog"),
            ("./projectBundle.js", "PrefabRegistry GameplayTriggerDefinition"),
            ("./render.js", "RenderFrameDiff"),
            ("./scene.js", "SceneId SceneNodeId SceneTransform FlatSceneDocument"),
            ("./voxelAsset.js", "VoxelAssetAuthoringMetadata VoxelAssetMaterialBinding VoxelVolumeAsset"),
            ("./gameExtension.js", "GameplayContractRef GameplayModuleRef GameplayModuleBinding GameplayModuleBindingOverride"),
            ("./input.js", "ProjectInputCatalog"),
        ],
        declarations: "const:PROJECT_CONTENT_SCHEMA_VERSION const:AUTHORED_BEHAVIOR_PACKAGE_SCHEMA_VERSION const:AUTHORED_BEHAVIOR_VOCABULARY_VERSION const:AUTHORED_BEHAVIOR_VOCABULARY_HASH const:AUTHORED_SIGNAL_PREFAB_PART_INTERACTED const:AUTHORED_PREDICATE_STATE_IS const:AUTHORED_VERB_TRANSITION_STATE const:AUTHORED_VERB_SET_RELATIVE_TRANSLATION const:AUTHORED_VERB_SET_CAPABILITY_ACTIVE const:AUTHORED_BEHAVIOR_MAX_MACHINES const:AUTHORED_BEHAVIOR_MAX_BEHAVIORS const:AUTHORED_BEHAVIOR_MAX_STATES_PER_MACHINE const:AUTHORED_BEHAVIOR_MAX_TRANSITIONS_PER_MACHINE const:AUTHORED_BEHAVIOR_MAX_STEPS_PER_BEHAVIOR const:AUTHORED_BEHAVIOR_MAX_OPERATIONS_PER_STEP const:AUTHORED_BEHAVIOR_MAX_ARGUMENTS const:AUTHORED_BEHAVIOR_MAX_DELAY_TICKS type:ProjectContentDocumentKind type:AuthoredBehaviorProvenance:AuthoredBehaviorProvenanceDto type:AuthoredBehaviorState:AuthoredBehaviorStateDto type:AuthoredBehaviorTransition:AuthoredBehaviorTransitionDto type:AuthoredBehaviorStateMachine:AuthoredBehaviorStateMachineDto type:AuthoredBehaviorSemanticRef:AuthoredBehaviorSemanticRefDto type:AuthoredBehaviorValue:AuthoredBehaviorValueDto:kind type:AuthoredBehaviorArgument:AuthoredBehaviorArgumentDto type:AuthoredBehaviorSignal:AuthoredBehaviorSignalDto type:AuthoredBehaviorCondition:AuthoredBehaviorConditionDto type:AuthoredBehaviorOperation:AuthoredBehaviorOperationDto type:AuthoredBehaviorStep:AuthoredBehaviorStepDto type:AuthoredBehaviorDefinition:AuthoredBehaviorDefinitionDto type:AuthoredBehaviorPackage:AuthoredBehaviorPackageDto type:ProjectContentSource:ProjectContentSourceDto type:ProjectConfigurationValueKind type:ProjectContentReferenceKind type:ProjectContentReferenceOption:ProjectContentReferenceOptionDto type:ProjectConfigurationField:ProjectConfigurationFieldDto type:ProjectConfigurationSchema:ProjectConfigurationSchemaDto type:ProjectConfigurationValue:ProjectConfigurationValueDto:kind type:ProjectConfigurationFieldValue:ProjectConfigurationFieldValueDto type:ProjectGameplayConfiguration:ProjectGameplayConfigurationDto type:ProjectGameplayConfigurationDocument:ProjectGameplayConfigurationDocumentDto type:ProjectPresentationResourceKind type:ProjectAnimatedMeshRuntimeFormat type:ProjectAnimationClipDescriptor:ProjectAnimationClipDescriptorDto type:ProjectMeshMaterialSlot:ProjectMeshMaterialSlotDto type:ProjectMeshBoundsDescriptor:ProjectMeshBoundsDescriptorDto type:ProjectAnimatedMeshDescriptor:ProjectAnimatedMeshDescriptorDto type:ProjectPresentationResource:ProjectPresentationResourceDto type:ProjectPresentationSignalDomain type:ProjectPresentationSignal:ProjectPresentationSignalDto type:ProjectPresentationCue:ProjectPresentationCueDto:kind type:ProjectPresentationCatalog:ProjectPresentationCatalogDto type:ProjectContentDocument:ProjectContentDocumentDto:kind type:ProjectContentDecodeRequest:ProjectContentDecodeRequestDto type:ProjectContentEncodeRequest:ProjectContentEncodeRequestDto type:ProjectContentDiagnosticCode type:ProjectContentDiagnostic:ProjectContentDiagnosticDto type:ProjectContentCanonicalFile:ProjectContentCanonicalFileDto type:ProjectContentFieldMetadata:ProjectContentFieldMetadataDto type:ProjectEntityAppearanceUpdate:ProjectEntityAppearanceUpdateDto:kind type:ProjectContentCodecResult:ProjectContentCodecResultDto type:ActiveRuntimeProjectDomainKind type:ActiveRuntimeProjectEntityRole type:ActiveRuntimeProjectEntityRoleReadout:ActiveRuntimeProjectEntityRoleReadoutDto type:ActiveRuntimeProjectDomainReadout:ActiveRuntimeProjectDomainReadoutDto type:ActiveRuntimeProjectContentReadout:ActiveRuntimeProjectContentReadoutDto type:ProjectContentAuthoringCommand:ProjectContentAuthoringCommandDto:kind type:ProjectContentAuthoringRequest:ProjectContentAuthoringRequestDto type:ProjectContentAuthoringResult:ProjectContentAuthoringResultDto type:ProceduralEnvironmentLimits:ProceduralEnvironmentLimitsDto type:ProceduralEnvironmentMarkerTarget:ProceduralEnvironmentMarkerTargetDto type:ProceduralEnvironmentTarget:ProceduralEnvironmentTargetDto type:ProceduralEnvironmentPreviewRequest:ProceduralEnvironmentPreviewRequestDto type:ProceduralEnvironmentDiagnosticCode type:ProceduralEnvironmentDiagnostic:ProceduralEnvironmentDiagnosticDto type:ProceduralEnvironmentProvenance:ProceduralEnvironmentProvenanceDto type:ProceduralEnvironmentMarkerReadout:ProceduralEnvironmentMarkerReadoutDto type:ProceduralEnvironmentSourceReadout:ProceduralEnvironmentSourceReadoutDto type:ProceduralEnvironmentCanonicalFile:ProceduralEnvironmentCanonicalFileDto type:ProceduralEnvironmentArtifactCandidate:ProceduralEnvironmentArtifactCandidateDto type:ProceduralEnvironmentPreviewResult:ProceduralEnvironmentPreviewResultDto type:ProceduralEnvironmentApplyRequest:ProceduralEnvironmentApplyRequestDto type:ProceduralEnvironmentApplyResult:ProceduralEnvironmentApplyResultDto",
    },
    ModulePlan {
        name: "diagnostics",
    ...
    ModulePlan {
        ...
        imports: &[],
        declarations: "const:INPUT_BINDING_CATALOG_SCHEMA_VERSION const:PROJECT_INPUT_CATALOG_SCHEMA_VERSION const:INPUT_CONTEXT_STATE_SCHEMA_VERSION const:INPUT_ACTION_RECORD_SCHEMA_VERSION type:InputActionId type:InputContextId type:InputBindingId type:InputValueKind type:InputActionPhase type:PlatformInputKind type:InputValue:InputValue:kind type:InputActionDefinition type:InputContextDefinition type:InputBindingExtension type:InputBindingRecord type:InputBindingCatalog type:ProjectInputCatalog type:InputSessionConfigureRequest type:ActiveInputContext type:InputContextStackState type:InputContextCommand:InputContextCommand:operation type:InputContextChangeReceipt type:InputSessionSnapshot type:RawInputSample type:ResolvedInputAction type:RecordedInputAction type:InputDiagnosticCode type:InputDiagnostic type:InputResolutionReceipt type:InputActionReplayReceipt",
    },
    ModulePlan {
        name: "timeControl",
    ...
    fn every_public_protocol_type_is_planned_or_exempted() {
        const EXEMPTIONS: &[(&str, &str)] = &[
            ...
            (
                ...
                "Rust-private canonical openProject adapter request, intentionally absent from public TS contracts",
            ),
            (
