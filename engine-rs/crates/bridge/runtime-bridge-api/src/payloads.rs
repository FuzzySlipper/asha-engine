...
pub use protocol_project_bundle::{
    ...
    RuntimeProjectGameplayCheckpointRestoreRequest, RuntimeProjectGameplayCheckpointSaveReceipt,
    RuntimeProjectGameplayCheckpointSaveRequest, RuntimeProjectLoadReceipt,
    RuntimeProjectLoadRequest, RuntimeProjectSourceAdapterInput, RuntimeProjectSourceAdapterKind,
    RuntimeProjectSourceBatch, StagedProjectResourceRef, WorkspaceAuthoringCloseReceipt,
    WorkspaceAuthoringCloseRequest, WorkspaceAuthoringCompositionStatus,
    WorkspaceAuthoringIdentity, WorkspaceAuthoringProjectBundleRef,
    WorkspaceAuthoringProjectIdentity, WorkspaceAuthoringProjectionReceipt,
    WorkspaceAuthoringProjectionRequest, WorkspaceAuthoringStateSummary,
    WorkspaceAuthoringStoredConfirmationReceipt, WorkspaceAuthoringStoredConfirmationRequest,
};
